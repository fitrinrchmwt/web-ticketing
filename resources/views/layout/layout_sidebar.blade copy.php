  ...
  <head>
    ...
    <!-- Skip links will be dynamically added by accessibility.js -->
     ...
     <link rel="stylesheet" href="plugins/fontawesome-free/css/all.min.css">
      ...
      .icon-green {
        color: green;
        font-size: 24px;              /* atur ukuran */
        -webkit-text-stroke: 1px #000; /* bikin garis luar (biar tebal) */
      }
...
.export-mode .export-hide{
    display:none !important;
      ...
      .daterangepicker .ranges li.active {
        background-color: #9B2244 !important; /* merah contoh */
        color: #fff !important;
      }
...
.loader-logo {
    ...
    animation: pulse 1.2s infinite ease-in-out;
      ...
      :root,
      [data-bs-theme=light] {
          --lte-sidebar-width: 240px !important; /* bebas mau berapa */
      }
      ...
      .info-box:hover {
        ...
        background-color: rgba(221,68,112,1) ; /* warna berubah */
      ...
      @keyframes wiggle { 0% { transform: rotate(0deg); } 30% { transform: rotate(10deg); } 60% { transform: rotate(-10deg); } 100% { transform: rotate(0deg); } }
  ...
  @php
        ...
        if (Session::has('loginId')) {
            $user = PenggunaModel::with('departemen')->find(Session::get('loginId'));
            $user = PenggunaModel::with('role')->find(Session::get('loginId'));
        }
    @endphp

  <body class="layout-fixed fixed-header sidebar-expand-lg sidebar-open sidebar-mini bg-body-tertiary">
              ...
              <a href="#" class="nav-link dropdown-toggle d-flex align-items-center" data-bs-toggle="dropdown">
                ...
                <div class="d-flex flex-column text-start">
                    ...
                    <small class="text-muted" style="line-height: 1;">
                       {{ $user && $user->departemen ? $user->departemen->nama_departemen : '-' }}-{{ $user && $user->role ? $user->role->nama_role : '-' }}
                    </small>
                </div>
              </a>

              <div class="dropdown-menu dropdown-menu-end shadow animated--grow-in"
                aria-labelledby="userDropdown" style="max-width: 50px;">
                <a class="dropdown-item" style="padding-right: 0px;">
                  <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                  {{ $user ? $user->username : 'Tamu' }}
                </a>
                <div class="dropdown-divider"></div>
                <a href="{{ route('logout') }}" style="padding-right: 0px;" class="dropdown-item" onclick="return confirm('Yakin ingin logout?')">
      ...
      <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
        ...
        <div class="sidebar-brand">
          ...
          <a href="./index.html" class="brand-link">
            <!--begin::Brand Image-->
            <img src="{{ asset('asset/img/logo.svg') }}" alt="Logo"
            class="brand-image opacity-75 shadow"/>
            <!--end::Brand Image-->
            <!--begin::Brand Text-->
            <span class="brand-text fw-light"><img src="{{ asset('asset/img/favicon.png') }}" alt="Logo" class="brand-image" style="display: none;"></span>
            <!--end::Brand Text-->
          </a>
          <!--end::Brand Link-->
        </div>
        ...
        <div class="sidebar-wrapper">
          <nav class="mt-2">
            <!--begin::Sidebar Menu-->
            <ul class="nav sidebar-menu nav-pills nav-sidebar flex-column" data-lte-toggle="treeview" role="navigation" aria-label="Main navigation" data-accordion="false" id="navigation">
              <li class="nav-item">
              ...
              <li class="nav-item has-treeview {{ request()->is('kelolakategori') || request()->is('kelolalayanan') || request()->is('kelolatemplate') || request()->is('kelola_template_deskripsi') || request()->is('keloladepartemen') || request()->is('kelolarole') || request()->is('kelolapengguna') || request()->is('kelolastatus') || request()->is('kelolasubject') ? 'menu-open' : '' }}">
                <a href="#" class="nav-link {{ request()->is('kelolakategori') || request()->is('kelolalayanan') || request()->is('kelolatemplate') || request()->is('kelola_template_deskripsi') || request()->is('keloladepartemen') || request()->is('kelolarole') || request()->is('kelolapengguna') || request()->is('kelolastatus') || request()->is('kelolasubject') ? 'active' : '' }}">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="{{ url('keloladepartemen') }}" class="nav-link {{ request()->is('keloladepartemen') ? 'active' : '' }}">
                  ...
                  <li class="nav-item">
                    <a href="{{ url('kelolapengguna') }}" class="nav-link {{ request()->is('kelolapengguna') ? 'active' : '' }}">
                      <i class="nav-icon bi bi-person-plus"></i>
                      <p>Master Pengguna</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="{{ url('kelolastatus') }}" class="nav-link {{ request()->is('kelolastatus') ? 'active' : '' }}">
                      <i class="nav-icon bi bi-check-square"></i>
                      <p>Master Status</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="{{ url('kelolakategori') }}" class="nav-link {{ request()->is('kelolakategori') ? 'active' : '' }}">
                      <i class="nav-icon bi bi-grid"></i>
                      <p>Master Kategori</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="{{ url('kelolalayanan') }}" class="nav-link {{ request()->is('kelolalayanan') ? 'active' : '' }}">
                      <i class="nav-icon bi bi-tools"></i>
                      <p>Master Layanan</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="{{ url('kelolatemplate') }}" class="nav-link {{ request()->is('kelolatemplate') ? 'active' : '' }}">
                      <i class="nav-icon bi bi-journal"></i>
                      <p>Master Template</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="{{ url('kelolasubject') }}" class="nav-link {{ request()->is('kelolasubject') ? 'active' : '' }}">
                      <i class="nav-icon bi bi-journal"></i>
                      <p>Master Subject</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="{{ url('kelola_template_deskripsi') }}" class="nav-link {{ request()->is('kelola_template_deskripsi') ? 'active' : '' }}">
                      <i class="nav-icon bi bi-journal"></i>
              ...
              <li class="nav-item">
                <a href="{{ url('dashboard-ticket') }}" class="nav-link {{ request()->is('dashboard-ticket') ? 'active' : '' }}">
      ...
      <!-- <script>
        document.addEventListener('DOMContentLoaded', function() {
            fetch("{{ route('chart.data') }}") // pastikan route-nya sesuai
                .then(response => response.json())
                .then(data => {
                    ...
                    new Chart(ctx, {
                        ...
                        options: {
                            ...
                            plugins: {
                                ...
                                title: {
                                    display: true,
                                    text: 'Data Tiket Masuk & Keluar 6 Bulan Terakhir'
                                }
                            },
                            scales: {
                                y: {
