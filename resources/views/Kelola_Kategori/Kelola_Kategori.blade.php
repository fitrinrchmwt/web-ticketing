...
<!--begin::App Content Header-->
        <div class="app-content-header">
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-sm-6">
                <h4 class="mb-0" style="margin-left: 5px">Kelola Kategori Ticket</h4>
              </div>
            <!--end::Row-->
          </div>
          <!--end::Container-->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        @include('Kelola_Kategori.Form_Tambah')
                        <div class="card-body" style="max-height: 700px">
                            ...
                            <div class="table-responsive" style="max-height: 400px; overflow-y: auto;">
                                <table id="tabelKategori" class="table table-bordered table-striped text-center" width="100%"cellspacing="0">
                                    <thead >
                                        <tr>
                                    ...
                                    <tbody>
                                        @foreach ($datakategori as $key => $kategori)
                                            <tr>
                                                ...
                                                <td width='20%'>
                                                    <button type="button" class="btn btn-success btn-sm mb-2 edit-kategori-btn"  data-bs-toggle="modal" data-bs-target="#modalFormEdit"
                    ...
                    <script>
                        document.addEventListener('DOMContentLoaded', function () {
                            const buttons = document.querySelectorAll('.edit-kategori-btn');

                            buttons.forEach(button => {
                                button.addEventListener('click', function () {
                                    document.getElementById('edit_id_kategori').value = this.dataset.id_kategori;
                                    document.getElementById('edit_nama_kategori').value = this.dataset.nama_kategori;
                    ...
                    @include('Kelola_Kategori.Form_Edit')
                </div>
            </div>
            <!-- /.row -->   
          </div>
...
@section('script')
    ...
    <script>
        $(function () { 
            let table = $('#tabelKategori').DataTable({ 
                responsive: false, 
                lengthChange: true, 
                autoWidth: false, 
